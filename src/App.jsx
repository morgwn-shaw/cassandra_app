        ...
        <div className="h-screen w-screen font-mono flex overflow-hidden bg-[#0d0f11] text-slate-400 select-none">
            ...
            <aside className="w-[320px] border-r border-slate-800 bg-black/60 p-8 flex flex-col gap-6 shadow-2xl shrink-0">
                ...
                <div className="mt-auto space-y-4 pt-6 border-t border-slate-900">
                    ...
                    <button onClick={() => runAction('/purge', {})} className="w-full p-4 bg-red-950/20 border border-red-900/30 text-red-500 text-[10px] font-black uppercase hover:bg-red-600 transition-all">World_Reset</button>
                </div>
            </aside>
                                        ...
                                        {(activeItem?.episodes || []).map((ep, idx) => (
                                            <div key={idx} className="p-8 bg-[#1c1f23] border border-slate-800 group hover:border-teal-500 transition-all flex flex-col gap-4 shadow-xl rounded-2xl">
                                                <div className="flex justify-between items-center">
                                                    <span className="text-teal-500 text-[10px] font-black uppercase tracking-widest italic">NODE {ep?.act}</span>
