...
const CONFIG = {
    ...
    DYNAMICS: ["UST - High Friction", "Strategic Tension", "Grudging Mutual Respect", "Bitter Rivals", "Frenemies"],
    TRAUMAS: ["Witnessed server farm bleed-out.", "Neural-link betrayal.", "Identity theft.", "Digital cult escape."]
};
...
const App = () => {
    ...
    const getBrief = async (seasonId, idx) => {
        ...
        try {
            ...
            window.alert(`SHOWRUNNER_FAILED: ${e.message}`); 
        ...
        <div className="h-screen w-screen font-mono flex overflow-hidden bg-[#0d0f11] text-slate-400">
            ...
            {viewMode === 'god' && (
                <section className="w-[320px] border-r border-slate-800 bg-black/40 p-6 flex flex-col gap-6 shadow-2xl overflow-hidden">
                    <div className="flex items-center gap-2 text-teal-500 font-black text-[10px] mb-8 uppercase tracking-[0.3em] border-b border-slate-900 pb-4"><Zap size={14} /> Telemetry_v30.1</div>
                        ...
                        {activeTab === 'season' && (
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                                <div className="space-y-6">
                                    <div className="bg-teal-500/5 p-6 border border-teal-500/20 rounded shadow-2xl">
                                ...
                                <div className="lg:col-span-2 bg-black/40 border border-slate-800 rounded p-10 h-[800px] overflow-y-auto shadow-2xl relative">
                                    ...
                                    {briefLoading && (
                                        <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center backdrop-blur-sm z-10">
                                            ...
                                            <p className="text-teal-400 text-[9px] font-black uppercase tracking-widest animate-pulse italic">Fact_Checking_Google_Grounding...</p>
                                        </div>
                                    )}
                                    ...
                                    )) : <div className="h-full flex items-center justify-center text-slate-800 text-[9px] font-black uppercase tracking-widest italic opacity-20">Initialize_Showrunner_Signal</div>}
                                </div>
                            </div>
                        )}
                    </div>
