...
const App = () => {
    ...
    const [logs, setLogs] = useState([{ t: new Date().toLocaleTimeString(), m: "APEX_V202_STITCH_PRUNE_LOCKED", type: "system" }]);
    ...
    const [nP, setNP] = useState({ name: '', role: 'Host', gender: CONFIG.G[0], description: "Forensic Analyst.", trauma: '' });
