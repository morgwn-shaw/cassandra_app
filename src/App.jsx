...
import { Trash2, UserPlus, Wifi, Cpu, X, Archive, BookOpen, History, ChevronRight, FileText, Activity, Zap, Terminal, Mic2, Headphones, Sparkles, UserCircle, HeartPulse } from 'lucide-react';

const BASE_URL = "https://shadow-cassandrafiles.pythonanywhere.com/api/v2";
const DESC_SAMPLES = [
    "A jaded investigative journalist who treats every fact like a crime scene. Cynical cadence, high curiosity, low risk tolerance.",
    "A hyper-enthusiastic tech futurist obsessed with neural interfaces. Fast speech, breathless curiosity, extremely high risk taker.",
    "A retired intelligence operative who speaks in riddles and obscure history. Gravelly voice, stoic, cautious curiosity.",
    "A street-smart data broker who values information over human life. Sharp, clipped speech, transactional mindset."
];
const CONFIG = {
...
const App = () => {
    ...
    const [logs, setLogs] = useState([{ t: new Date().toLocaleTimeString(), m: "APEX_V185_ATOMIC", type: "system" }]);
    ...
    const createSeason = async () => {
        ...
        try {
            ...
            setStatus("Researching Episodes...");
            addLog("EPISODE_RESEARCH_START...");
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <select className="bg-slate-900/50 p-4 border border-slate-800 text-teal-500 rounded-2xl outline-none uppercase font-black" value={nP.role} onChange={e => setNP({...nP, role: e.target.value})}>
                            <option value="Host">Host</option><option value="Skeptic">Skeptic</option><option value="Historian">Historian</option>
                        </select>
                    </div>
