...
// Safe Rendering Component: Physically prevents non-objects from crashing the app
const BriefDisplay = ({ data }) => {
    if (!data || typeof data !== 'object' || Array.isArray(data)) return (
        <div className="h-64 flex flex-col items-center justify-center text-slate-700 text-[10px] font-black uppercase italic animate-pulse text-center">
            Establishing intelligence uplink...
        </div>
    );
...
const App = () => {
    ...
    // PURGE: Clear transient data when switching context to prevent reference errors
        ...
        <div className="h-screen w-screen font-mono flex bg-[#0a0c0e] text-slate-400 overflow-hidden select-none text-[12px]">
            <aside className="w-[300px] border-r border-slate-800 bg-black/60 p-8 flex flex-col gap-6 shrink-0 shadow-2xl">
                <div className="border-b border-slate-900 pb-4">
                    <div className="flex items-center gap-3 text-teal-500 font-black text-sm uppercase tracking-widest"><Cpu size={16}/> Apex_v135.0</div>
