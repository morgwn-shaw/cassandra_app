...
import { Trash2, Loader2, UserPlus, Wifi, Cpu, X, Archive, Clock, Layers, Copy, PlayCircle, BookOpen } from 'lucide-react';
        ...
        <div className="h-screen w-screen font-mono flex bg-[#0a0c0e] text-slate-400 overflow-hidden text-[12px] select-none">
            ...
            <aside className="w-[380px] bg-black/60 p-10 border-l border-slate-800 overflow-y-auto shrink-0 flex flex-col gap-10 custom-scrollbar shadow-2xl">
                <div className="space-y-6">
                    ...
                    <button onClick={() => run('/persona/create', nP)} disabled={!nP.name} className="w-full py-4 bg-teal-500 text-black font-black uppercase text-[10px] rounded-xl hover:bg-white transition-all shadow-xl shadow-teal-500/10">Commit DNA</button>
