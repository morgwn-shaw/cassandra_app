        ...
        <div className="h-screen w-screen font-mono flex bg-[#0a0c0e] text-slate-400 overflow-hidden text-[12px] select-none">
            ...
            <main className="flex-1 flex flex-col p-10 bg-[#0d0f11] relative overflow-hidden">
                ...
                <div className="flex gap-4 mb-6 border-b border-slate-800 pb-6 shrink-0">
                    ...
                    {activeId && <div className="flex-1 text-teal-500 font-black uppercase flex items-center gap-4 italic truncate tracking-widest">
                        <span>Season: {activeSeason?.title}</span>
                        <span className="text-slate-600 font-normal">[{activeSeason?.target_runtime}m Format]</span>
                    </div>}
                </div>
                        ...
                        {seasons.map(s => (
                            <div key={s.id} onClick={() => setActiveId(s.id)} className="bg-[#1c1f23] p-8 border border-slate-800 rounded-3xl cursor-pointer hover:border-teal-500 transition-all relative group h-fit shadow-xl">
                                ...
                                <div className="flex items-center gap-4 mt-2">
                                    ...
                                    <span className="text-[10px] text-slate-500">{s.ep_count} Eps / {s.target_runtime} Min</span>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="space-y-6 border-t border-slate-900 pt-8">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between text-[8px] font-black text-slate-500 uppercase italic">
                            ...
                            <span>{nS.episodes_count} EP</span>
                        </div>
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between text-[8px] font-black text-slate-500 uppercase italic">
                            ...
                            <span>{nS.target_runtime} MIN</span>
                        </div>
                        <input type="range" min="5" max="20" step="1" className="w-full accent-teal-500 h-1 bg-slate-800 rounded-lg appearance-none cursor-pointer" value={nS.target_runtime} onChange={e => setNS({...nS, target_runtime: e.target.value})} />
                    </div>
