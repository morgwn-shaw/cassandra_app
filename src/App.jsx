...
import { Zap, Activity, Trash2, Database, Quote, Brain, Loader2, Fingerprint, ScrollText, ShieldCheck, Dice5, UserPlus, ShieldAlert, ChevronRight, PlayCircle, MessageSquare } from 'lucide-react';
    ...
    return (
        <div className="h-screen w-screen font-mono flex overflow-hidden bg-[#0d0f11] text-slate-400">
            ...
            <aside className="w-[320px] border-r border-slate-800 bg-black/60 p-8 flex flex-col gap-6 shadow-2xl shrink-0">
                ...
                <button onClick={() => runAction('/purge', {})} className="p-4 bg-red-950/20 border border-red-900/30 text-red-500 text-[11px] font-black uppercase flex items-center justify-center gap-3 hover:bg-red-600 hover:text-white transition-all">
                                    ...
                                    <div className="bg-black/40 border border-slate-800 rounded-3xl p-12 h-[850px] overflow-y-auto shadow-2xl relative">
                                        <div className="flex justify-between items-center mb-10 border-b border-slate-900 pb-6">
                                            <div className="flex flex-col">
                                                <h4 className="text-teal-500 text-[12px] font-black uppercase flex items-center gap-4"><ShieldCheck size={24}/> Production_Brief</h4>
